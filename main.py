...
from src.io_modules.proxies import get_working_proxy, read_proxies_from_file
...
def menu():
    ...
    while True:
        ...
        options = [
            [('01', 'TokenInfo'), ('02', 'GuildInfo')],
            [('03', 'TokensValidator'), ('', '')],
            [('', ''), ('', '')],
            [('04', 'Scraper'), ('05', 'Invite Creator')],
            [('', ''), ('', '')],
            [('06', 'Joiner'), ('07', 'Leaver')],
            [('08', 'RuleAccepter'), ('09', 'ButtonClicker')],
            [('10', 'VCJoiner'), ('11', 'Reaction')],
            [('', ''), ('', '')],
            [('12', 'Onliner'), ('13', 'Spammer')],
            [('14', 'Spamthreadsall'), ('', '')],
            [('', ''), ('', '')],
            [('15', 'Nick Chooser'), ('16', 'HypeSquadChooser')],
            [('17', 'Typier'), ('18', 'BioChanger')],
        ]
        ...
        module_map = {
            ('1', '01'): ("TokenInfo", "src/token_info.py"),
            ('2', '02'): ("GuildInfo", "src/guild_info.py"),
            ('3', '03'): ("TokensValidator", "src/tokens_validator.py"),
            ('4', '04'): ("Scraper", "src/scraper.py"),
            ('5', '05'): ("Invite Creator", "src/invite_creator.py"),
            ('6', '06'): ("GuildJoiner", "src/joiner.py"),
            ('7', '07'): ("GuildLeaver", "src/leaver.py"),
            ('8', '08'): ("RuleAccepter", "src/rule_accepter.py"),
            ('9', '09'): ("ButtonClicker", "src/button_clicker.py"),
            ('10'): ("VCJoiner", "src/vc_joiner.py"),
            ('11'): ("Reaction", "src/reaction.py"),
            ('12'): ("Onliner", "src/onliner.py"),
            ('13'): ("Spammer", "src/spammer.py"),
            ('14',): ("Spamthreadsall", "src/spam_threads_all.py"),
            ('15',): ("Nick Chooser", "src/nick_chooser.py"),
            ('16',): ("HypeSquadChooser", "src/hype_squad_chooser.py"),
            ('17',): ("Typier", "src/typier.py"),
            ('18',): ("BioChanger", "src/bio_changer.py"),
        }
